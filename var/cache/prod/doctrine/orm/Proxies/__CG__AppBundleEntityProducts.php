...
class Products extends \AppBundle\Entity\Products implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Products' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Products' . "\0" . 'sku', '' . "\0" . 'AppBundle\\Entity\\Products' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Products' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Products' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Products' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Products' . "\0" . 'category'];
        }
